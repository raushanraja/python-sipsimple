...
cdef class VideoTeeProducer(VideoProducer):
    ...
    def __init__(self, cdef RemoteVideoStream * remote_video_stream, object resolution, int fps):
        ...
        try:
            ...
            self._video_port = (cdef pjmedia_vid_port *)remote_video_stream._video_port
