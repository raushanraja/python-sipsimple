...
class RttTextStream(RTPStream):
    ...
    def _set_muted(self, value):
        ...
        notification_center.post_notification('RTTTextPortDidChangeSlots', sender=self, data=data)
    ...
    def _create_transport(self, rtp_transport, remote_sdp=None, stream_index=None):
        return RttTextTransport(self.mixer, rtp_transport, remote_sdp=remote_sdp, sdp_index=stream_index or 0, codecs=codecs)
